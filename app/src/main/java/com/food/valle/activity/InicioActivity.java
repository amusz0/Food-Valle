...
import com.food.valle.databinding.ActivityInicioBinding;
...
public class InicioActivity extends AppCompatActivity {
    ...
    private void loadData() {
        ...
        if(usuarioJson != null){
            ...
            String url = ConfigApi.ipFranky + "/api/documento-almacenado/download/" + u.getCliente().getFoto().getFileName();
