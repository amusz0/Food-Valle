package com.food.valle.activity.ui.inicio;
...
import com.food.valle.R;
import com.food.valle.adapter.CategoriaAdapter;
import com.food.valle.adapter.PlatillosRecomendadosAdapter;
import com.food.valle.adapter.SliderAdapter;
import com.food.valle.communication.Communication;
import com.food.valle.communication.MostrarBadgeCommunication;
import com.food.valle.entity.SliderItem;
import com.food.valle.entity.service.DetallePedido;
import com.food.valle.entity.service.Platillo;
import com.food.valle.utils.Carrito;
import com.food.valle.viewmodel.CategoriaViewModel;
import com.food.valle.viewmodel.PlatilloViewModel;
...
public class InicioFragment extends Fragment implements Communication, MostrarBadgeCommunication {
    ...
    private void loadData() {
        ...
        lista.add(new SliderItem(R.drawable.comidas_ricas, "Comidas favoritas"));
        lista.add(new SliderItem(R.drawable.salchipapas_ricas, "Las Mejores Salchipapas"));
        lista.add(new SliderItem(R.drawable.bugers, "Las Mejores Hamburguesas"));
        lista.add(new SliderItem(R.drawable.pizzas_ricas, "Las Mejores Pizzas"));
