package com.food.valle.adapter;
...
import com.food.valle.activity.DetallePlatilloActivity;
...
public class PlatillosRecomendadosAdapter extends RecyclerView.Adapter<PlatillosRecomendadosAdapter.ViewHolder> {
    ...
    protected class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setItem(final Platillo p) {
            ...
            String url = ConfigApi.ipFranky + "/api/documento-almacenado/download/" + p.getFoto().getFileName();
